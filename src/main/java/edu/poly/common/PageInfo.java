...
public class PageInfo {
	...
	static {
		...
		pageRoute.put(PageType.SITE_FORGOT_PASSWORD_PAGE, new PageInfo("Fogot - Password","/sites/users/forgot-password.jsp",null));
		pageRoute.put(PageType.SITE_FAVORITE_PAGE, new PageInfo("Favorite","/sites/users/favorite.jsp",null));
		pageRoute.put(PageType.SITE_VIDEO_DETAIL_PAGE, new PageInfo("Detalis","/sites/users/detail.jsp",null));
		pageRoute.put(PageType.SITE_SHARE_PAGE, new PageInfo("Shares","/sites/videos/share.jsp",null));
		pageRoute.put(PageType.SITE_AboutUs_PAGE, new  PageInfo("About Us", "/sites/users/AboutUs.jsp", null));
	}
	...
	public void setContentUrl(String contenUrl) {
		this.contentUrl = contentUrl;
	}
